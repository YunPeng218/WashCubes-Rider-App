...
import 'package:washcube_rider_app/src/features/screens/dropoff_laundrysite/order_complete_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.jobType == "Site Drop Off"
              ? 'Laundry Site Drop Off'
              : 'Laundry Site Pick Up',
        ),
      ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    widget.jobType == "Site Drop Off"
                        ? 'Drop Off Location: WashCubes Laundry Site'
                        : 'Drop Off Location: ${widget.activeJobLocation?.name ?? 'Loading...'}',
                    style: CTextTheme.blackTextTheme.headlineSmall,
                  ),
                ],
              ),
