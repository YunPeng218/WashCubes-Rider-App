...
import 'package:washcube_rider_app/src/features/screens/archive/dropoff_lockersite/dropoff_lockersite2_screen.dart';
...
class DropOffLocker extends StatefulWidget {
  ...
  @override
  State<DropOffLocker> createState() => _DropOffLockerState();
}
...
class _DropOffLockerState extends State<DropOffLocker> {
  ...
  final List<Map<String, dynamic>> items = [
    ...
    },
    {
      ...
      'scan': 'Photo',
      'description': 'Photo upon delivery',
      'scanned': false,
    },
  ];
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        Navigator.pushAndRemoveUntil(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const DropOffLocker2()),
                            (route) => false);
                      },
                      child: Text(
                        'Next Location',
