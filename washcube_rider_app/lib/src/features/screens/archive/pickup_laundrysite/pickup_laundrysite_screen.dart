...
import 'package:washcube_rider_app/src/features/screens/archive/dropoff_lockersite/dropoff_lockersite1_screen.dart';
...
class PickupCentre extends StatefulWidget {
  ...
  @override
  State<PickupCentre> createState() => _PickupCenterState();
}
...
class _PickupCenterState extends State<PickupCentre> {
  ...
  final List<Map<String, dynamic>> items = [
    {
      'action': 'order_number0000',
      'scan': 'Scan',
      'description': "Scan Tag",
      'scanned': false,
    },
    {
      'action': 'order_number0001',
      'scan': 'Scan',
      'description': "Scan Tag",
      'scanned': false,
    },
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        Navigator.pushAndRemoveUntil(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const DropOffLocker()),
                            (route) => false);
                      },
                      child: Text(
                        'Picked Up',
